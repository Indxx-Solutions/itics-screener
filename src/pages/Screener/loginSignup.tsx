...
const LoginSignup: React.FC = () => {
  ...
  const carouselItems = [
    "Streamlining Index Operations",
    "Integrated Client Delivery and Client Repository",
    "Real-Time Mapping & Generation",
    "Advanced Corporate Action Processing",
    "Role-Based Access & Approval Workflows",
    "Advance File Creation",
    "Global Corporate Action Data",
  ];
    ...
    <div className={`lc_wrap lc_door_${doorState}`}>
              ...
              <>
                ...
                >
                  ...
                  <Form.Item
                    name="password"
                    label="Password"
                    className="login_lable MB0 MT10"
                    hasFeedback
      ...
      <div className="lc_right lc_door_panel_right">
        ...
        <div className="lc_right_content">
          ...
          <div className="gradient_subheading">Indexing Made Effortless</div>
